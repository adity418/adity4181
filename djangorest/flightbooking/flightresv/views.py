...
from flightresv.models import Flight, Passenger, Reservation
from flightresv.serializers import FlightSerializer, PassengerSerializer, ReservationSerializer
